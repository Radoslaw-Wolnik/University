...
if __name__ == "__main__":
    ...
    print(tree_list.preorder_print(tree.root, "")[:-1])
    print(tree_list.inorder_print(tree.root, "")[:-1])
    print(tree_list.postorder_print(tree.root, "")[:-1])
    ...
    print(tree_c.Height(tree.root))
    print(tree_c.CountLeaves(tree.root))
    print(tree_c.CountNodes(tree.root))
    ...
    print(Test.CountLeaves(tree.root))
    print(Test.CountNodes(tree.root))
